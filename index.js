...
app.get("/jokes/:id", (req, res) => {
  ...
  const foundJoke = jokes.find((chutkula) => chutkula.id === id);    //const result = arrayName.find((element) => element.propertytocheck === valuetomatch)
  res.json(foundJoke);
})
...
app.put("/jokes/:id", (req, res) => {
  ...
  const jokeIndex = jokes.findIndex((joke) => joke.id === id);    //const result = arrayName.find((element) => element.propertytocheck === valuetomatch)
